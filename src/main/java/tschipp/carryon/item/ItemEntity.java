...
public class ItemEntity extends Item {
    ...
    public ItemEntity(int id, Material material) {
        super(id, "carryon_entity", 1);
    ...
    @Override
    public IIcon getIconFromSubtype(int subtype) {
        return this.cz;
    }
        ...
        if (hasEntityData(stack))
        {
            if (entity instanceof EntityLiving)
            {
                ...
                if (living instanceof EntityPlayer)
                {
                    ...
                    if (player.inCreativeMode()) return;
                }

                living.addPotionEffect(new MobEffect(MobEffectList.moveSlowdown.id, 1, potionLevel(stack), false));
            }
        }
    ...
    public static boolean storeEntityData(Entity entity, World world, ItemStack stack)
    {
        ...
        String name = EntityTypes.getEntityString(entity);
    ...
    public static Entity getEntity(ItemStack stack, World world)
    {
        ...
        Entity entity = EntityTypes.createEntityByName(name, world);
